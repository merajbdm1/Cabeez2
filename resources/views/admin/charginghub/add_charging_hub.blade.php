    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Add Charging Hub</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Add charging Hub</li>
                        </ol>
                        ...
                        @if ($message = Session::get('success'))
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Add Hub</small></h3>
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="quickForm" action="{{ url('hub_post') }}" method="POST"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="address"
                                                        class="form-control"
                                                        id="exampleFirstName" placeholder="Enter Address" value="{{ old('address') }}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="hub_name"
                                                        class="form-control"
                                                        id="exampleLastName" placeholder="Enter Hub Name" value="{{ old('hub_name') }}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="hub_address"
                                                        ...
                                                        class="form-control"
                                                        id="exampleMobileNumber" placeholder="Enter Hub Address" value="{{ old('hub_address') }}">
