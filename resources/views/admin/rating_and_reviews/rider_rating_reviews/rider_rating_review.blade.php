    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Rider Rating & Reviews</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Rider Rating & Reviews</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <form action="{{ route('search') }}" method="GET">
                                            ...
                                            <div class="form_group">
                                                ...
                                                <label for="">Rider Mobile Number</label>
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-bordered table-striped" >
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Rider Mobile Number</th>
                                                <th>Driver Name Form</th>
                                                <th>Rider Name To</th>
                                                <th>Rider Rating</th>
                                                <th>Rider Reviews</th>
                                                <th>Created Date</th>
