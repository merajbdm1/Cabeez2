                            ...
                            <div class="card-header">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <form action="{{url('updateNightStartTime/'.$ng_start_time)}}" method="POST">
                                                @csrf
                                            <th class="text-center">NIGHT FARE START TIME</th>
                                            <td class="text-center"> <input type="time" id="appt" class="form-control" value="{{isset($ng_start_time)?$ng_start_time:null}}" placeholder="REST MAP SDK KEY" name="night_fare_start_time"></td>
                                            <td class="text-center">
                                                @if('1')
                                                    <span class="badge badge-success">Active</span>
                                                @else
