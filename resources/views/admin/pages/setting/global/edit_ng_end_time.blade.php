                            ...
                            <div class="card-header">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <form action="{{url('updateNightENDTime/'.$ng_end_time)}}" method="POST">
                                                @csrf
                                            <th class="text-center">NIGHT FARE END TIME</th>
                                            <td class="text-center">  <input type="time" class="form-control" value="{{isset($ng_end_time)?$ng_end_time:null}}"  id="appt" name="night_fare_end_time"></td>
                                            <td class="text-center">
                                                @if('1')
                                                    <span class="badge badge-success">Active</span>
                                                @else
