                            ...
                            <div class="card-header">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <form action="{{url('updatemapsdkkey/'.$edimapsdkkey)}}" method="POST">
                                                @csrf
                                            <th class="text-center">MAP MY INDIA REST MAP SDK KEY</th>
                                            <td class="text-center"><input type="text" name="rest_map_sdk_key" value="{{isset($edimapsdkkey)?$edimapsdkkey:null}}" placeholder="REST MAP SDK KEY" class="form-control"></td>
                                        ...
                                        <tbody>
                                            ...
                                            <td class="text-center"><a href="{{'../view_globalclientapikey/'.$clientapikey}}" disabled class="btn btn-primary" value="submit" name="submit">Edit</a></td>
                                            </form>
                                        </tbody>
                                        <tbody>
                                            <form action="">
                                            ...
                                            <td class="text-center"><a href="{{'../view_global_map_my_india_secret_key/'.$secretkey}}" disabled class="btn btn-primary" value="submit" name="submit">Edit</a></td>
                                            </form>
                                        </tbody>
                                        ...
                                        <tbody>
                                            ...
                                            <td class="text-center"><a href="{{'../view_night_fare_start_time/'.$ng_start_time}}" disabled class="btn btn-primary" value="submit" name="submit">Edit</a></td>
                                            </form>
                                        </tbody>
                                        <tbody>
                                            <form action="">
                                        ...
                                        <tbody>
                                            ...
                                            <td class="text-center">  <input type="number" disabled value="{{isset($night_fare_multiplyaer)?$night_fare_multiplyaer:null }}" class="form-control" id="appt" name="night_fare_end_time"></td>
                                            <td class="text-center">
                                                @if('1')
                                                    <span class="badge badge-success">Active</span>
                                                @else
