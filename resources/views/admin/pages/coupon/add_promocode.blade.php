...
<section class="content">
    <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!--  form start -->
        <form id="quickForm" action="{{url('post_promocode')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="code" class="form-control{{ $errors->has('code') ? ' is-invalid' : '' }}" id="exampleCode" placeholder="Code">
                            @if ($errors->has('code'))
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" id="exampletitle" placeholder="Title">
                            @if ($errors->has('title'))
                            <span class="invalid feedback" role="alert">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="discount" class="form-control{{ $errors->has('discount') ? ' is-invalid' : '' }}" id="discount" placeholder="Discount">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="usage_limit" class="form-control{{ $errors->has('usage_limit') ? ' is-invalid' : '' }}" id="usage_limit" placeholder="Usage Limit">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="max_discount" class="form-control{{ $errors->has('max_discount') ? ' is-invalid' : '' }}" id="max_discount" placeholder="Max Discount">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="code_rule" class="form-control{{ $errors->has('code_rule') ? ' is-invalid' : '' }}" id="code_rule" placeholder="Code Rule">
